...
mixin _$TimeEntry {
  ...
  @NullableDateTimeIso8601Converter()
...
abstract class $TimeEntryCopyWith<$Res> {
  ...
  $Res call({
    String id,
    String taskId,
    @DateTimeIso8601Converter() DateTime start,
...
class _$TimeEntryImpl extends _TimeEntry {
  const _$TimeEntryImpl({
    ...
    @DateTimeIso8601Converter() required this.start,
    @NullableDateTimeIso8601Converter() this.end,
    this.note,
  }) : super._();
  ...
  @override
  String toString() {
    return 'TimeEntry(id: $id, taskId: $taskId, start: $start, end: $end, note: $note)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, taskId, start, end, note);
...
abstract class _TimeEntry extends TimeEntry {
  const factory _TimeEntry({
    ...
    @DateTimeIso8601Converter() required final DateTime start,
    @NullableDateTimeIso8601Converter() final DateTime? end,
    final String? note,
  }) = _$TimeEntryImpl;
